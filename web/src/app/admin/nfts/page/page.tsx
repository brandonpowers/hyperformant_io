'use client';
// components
import Auction from 'components/dashboard/nfts/page/Auction';
import Description from 'components/dashboard/nfts/page/Description';
import TableLastOffer from 'components/dashboard/nfts/page/TableLastOffer';
import tableDataLastOffer from 'variables/nfts/page/tableDataLastOffer';
import NftCard from 'components/ui/card/NftCard';
import Banner from 'components/dashboard/nfts/page/Banner';
