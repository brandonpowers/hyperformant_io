...
const FreeCard = (props: { [x: string]: any }) => {
  ...
  return (
    <div
      className={`relative flex w-[240px] flex-col items-center rounded-[20px] bg-gradient-to-br from-brand-400 to-brand-600 py-6 ${
        mini === false
          ? ''
    ...
    >
      <BsArrowsAngleExpand
        className={`h-6 w-6 my-8 mx-5 text-white ${
