...
const Details = () => {
  return (
    <div className="flex h-full w-full flex-col items-center justify-between rounded-[20px] bg-clip-border px-[35px] pb-11 pt-8 shadow-3xl shadow-shadow-500 bg-card-light dark:!bg-card-dark dark:shadow-none md:flex-row">
      {/* left side */}
