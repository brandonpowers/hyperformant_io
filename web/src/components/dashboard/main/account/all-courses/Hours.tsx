...
const Hours = () => {
  return (
    <div className="w-full rounded-[20px] font-dm shadow-2xl shadow-gray-100 dark:border dark:!border-white/10 bg-card-light dark:!bg-card-dark dark:shadow-none">
      {/* Header */}
