  ...
  return (
    <Card extra={'mt-3 !z-5 overflow-hidden'}>
      ...
      {HistoryData.map((data, index) => (
        <div
          key={index}
          className="flex h-full w-full items-start justify-between px-3 py-[20px] hover:shadow-2xl bg-card-light dark:!bg-card-dark dark:shadow-none dark:hover:!bg-navy-700"
        >
