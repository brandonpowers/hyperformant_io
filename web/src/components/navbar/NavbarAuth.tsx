    ...
    >
      ...
      <Link href="/" className="flex items-center">
        ...
        <Image
          ...
          width={120}
          height={40}
          className={isMarketingPage ? "h-8 w-auto" : "h-8 w-auto dark:hidden"}
        />
      ...
      <div className="hidden items-center gap-4 xl:flex">
        {session ? (
          ...
          // Login/Signup buttons when not logged in and not on auth pages
          !isOnAuthPage && (
            <>
              <Link
                href="/auth/sign-in"
              ...
              <Link
                href="/auth/sign-up"
                className="linear rounded-xl bg-white px-4 py-2 text-sm font-medium text-brand-500 transition duration-200 hover:opacity-90 active:opacity-80"
              >
                Sign Up
              </Link>
            </>
