...
async function CompetitorInsights({ userId: _userId }: { userId: string }) {
          ...
          <div key={insight.id} className="border-l-4 border-blue-500 pl-4">
            <div className="flex items-center justify-between mb-2">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span
                  className={`text-sm font-medium ${getSentimentColor(insight.sentiment)}`}
                >
                  {insight.change > 0 ? '+' : ''}
                  {insight.change}%
                </span>
  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-gray-600 dark:text-gray-400">
          Real-time insights into your market intelligence and competitive
          positioning
        </p>
      </div>
