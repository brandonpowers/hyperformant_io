...
import SeeStory from 'components/ui/actions/SeeStory';
...
const Stories = () => {
  return (
    <div className="rounded-[20px] bg-clip-border shadow-3xl shadow-shadow-500 bg-card-light dark:!bg-card-dark dark:shadow-none lg:justify-between">
      <Scrollbars
        autoHide
