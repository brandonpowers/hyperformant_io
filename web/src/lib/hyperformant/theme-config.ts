...
export type ThemeConfig = {
  ...
  encodings: {
    ...
    glow: { key: string; polarity?: "pos" | "neg" | "both"; intensity: "low"|"med"|"high" };
  ...
  background: { clustersBy?: "industry" | "market"; halos: boolean; axes: boolean };
};
...
export const THEMES: ThemeConfig[] = [
  // 1) Market Landscape
  {
    ...
    encodings: {
      position: { x: "index.momentum", y: "index.techVelocity", z: "index.mindshare" },
      ...
      drift: { key: "metric.marketCapGrowth|metric.trafficGrowth", windowDays: 60 },
  ...
  // 2) Competitive Dynamics
  {
    ...
    encodings: {
      position: { x: "index.competitiveThreat", y: "index.techVelocity", z: "index.mindshare" },
    ...
    connections: {
      ...
      thickness: { key: "connection.overlapScore|connection.depth", scale: "linear" },
  ...
  // 3) Growth & Momentum
  {
    ...
    encodings: {
      position: { x: "index.growth", y: "metric.hiringVelocity", z: "index.dealMomentum" },
    ...
    connections: {
      ...
      thickness: { key: "connection.dealValue|connection.allianceDepth", scale: "log" },
  ...
  // 4) Risk & Stability
  {
    ...
    name: "Risk & Stability",
    encodings: {
      position: { x: "index.complianceRisk", y: "index.operationalStability", z: "index.sentimentStability" },
    ...
    connections: {
      ...
      thickness: { key: "connection.severity|connection.criticality", scale: "linear" },
  ...
  // 5) Innovation Velocity
  {
    ...
    encodings: {
      position: { x: "metric.rdIntensity|index.rdIndex", y: "metric.releaseCadence", z: "metric.communityMomentum|metric.ossMomentum" },
    ...
    connections: {
      ...
      thickness: { key: "connection.collabDepth|connection.sharedModules", scale: "linear" },
  ...
  // 6) Investor / M&A Lens
  {
    ...
    name: "Investor / M&A",
    encodings: {
      position: { x: "index.acquisitionReadiness", y: "index.growthQuality", z: "index.strategicFitToUser" },
    ...
    connections: {
      ...
      thickness: { key: "connection.checkSize|connection.equityPct|connection.integrationDepth", scale: "log" },
