...
const navigation = {
  product: [
    ...
    { name: "Market Forces", href: "#features", external: false },
    { name: "Reports", href: "/dashboard", external: false },
  ],
  resources: [
    { name: "Documentation", href: "#", external: false },
    { name: "LinkedIn", href: "https://linkedin.com/company/hyperformant", external: true },
    { name: "Twitter", href: "https://twitter.com/hyperformant", external: true },
    { name: "GitHub", href: "https://github.com/hyperformant", external: true },
  ],
  company: [
    { name: "About", href: "/about", external: false },
    { name: "Contact", href: "mailto:hello@hyperformant.io", external: false },
      ...
      <div className="mx-auto max-w-6xl px-3 pb-8 pt-16 sm:pt-24 lg:pt-32">
        <div className="xl:grid xl:grid-cols-3 xl:gap-20">
          <div className="space-y-8">
            ...
            <p className="text-sm leading-6 text-gray-600 dark:text-gray-400">
              AI-powered market intelligence platform for B2B automation and competitive analysis. 
              Discover competitor vulnerabilities and accelerate revenue growth.
            </p>
            <div className="flex space-x-6">
              {/* Theme switch placeholder - can be added later */}
            </div>
            <div></div>
          </div>
        ...
        <div className="mt-16 flex flex-col items-center justify-between gap-4 border-t border-gray-200 pt-8 sm:mt-20 sm:flex-row lg:mt-24 dark:border-gray-800">
          <p className="text-sm leading-5 text-gray-500 dark:text-gray-400">
            &copy; {new Date().getFullYear()} Hyperformant, Inc. All rights reserved.
          </p>
          <div className="rounded-full border border-gray-200 py-1 pl-1 pr-2 dark:border-gray-800">
            <div className="flex items-center gap-1.5">
              <div className="relative size-4 shrink-0">
                <div className="absolute inset-0 rounded-full bg-emerald-500/20 dark:bg-emerald-600/20" />
                <div className="absolute inset-[2px] rounded-full bg-emerald-600 dark:bg-emerald-500" />
              </div>
